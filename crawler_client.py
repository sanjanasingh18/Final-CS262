...
class CrawlerClient:   
    def __init__(self):
        ...
        try:
            self.connection = scrape_pb2_grpc.CrawlStub(grpc.insecure_channel(f"{HOST}:{PORT}"))
    ...
    def get_player_info_and_date(self, html):
        ...
        # TODO make the player count dictionary for each player mentioned and set that dic to be the dic in our data object
